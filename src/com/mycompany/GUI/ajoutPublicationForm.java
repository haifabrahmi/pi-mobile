...
public class ajoutPublicationForm extends BaseForm {
    ...
    public ajoutPublicationForm(Resources res){
       // super("Newsfeed",BoxLayout.y());
        ...
        final Dialog ipDlg = ip.showInifiniteBlocking();
            ...
            ListPublicationFrom a = new ListPublicationFrom(res);
            a.show();
            refreshTheme();
        });
       ...
       Button btnAjouterImage = new Button("Ajouter une image");
       // btnAjouterImage.addActionListener(e -> {
           /* if (FileChooser.isAvailable()) {
                FileChooser.showOpenDialog(false, "image/jpeg,image/png", e2 -> {
                    if (e2 != null && e2.getSource() != null) {
                        ...
                        try {
                            ...
                            image = EncodedImage.create(data, data.length);
    ...
    /*    });*/
        addStringValue("", btnAjouterImage);
           ...
           btnAjouter.addActionListener((e) -> {
            ...
            try {
                ...
                if(titre.getText().equals("") || text.getText().equals("")) {
                    ...
                    Publication r = new Publication(String.valueOf(text.getText()
                                  ).toString(),
                    ...
                    ServicePublicaton.getInstance().ajouterPublication(r);
