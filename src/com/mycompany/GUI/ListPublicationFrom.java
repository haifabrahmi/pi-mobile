 ...
 * @author asus
 */
public class ListPublicationFrom extends BaseForm{
      Form current;
    public ListPublicationFrom(Resources res ) {
          super("Newsfeed",BoxLayout.y()); //herigate men Newsfeed w l formulaire vertical
        Toolbar tb = new Toolbar(true);
        current = this ;
        setToolbar(tb);
        getTitleArea().setUIID("Container");
        setTitle("list Publication");
        ...
        */
        ...
        ArrayList<Publication>list = ServicePublicaton.getInstance().afficherPublication();
        
        for(Publication rec : list ) {
             String urlImage ="back.png";//image statique pour le moment ba3d taw fi  videos jayin nwarikom image 
    ...
    private void addButton(Image img,Publication rec , Resources res) {
        ...
        Label objetTxt = new Label("Date : "+rec.getDatePub(),"NewsTopLine2");
        Label dateTxt = new Label("Titre : "+rec.getTitre(),"NewsTopLine2");
        Label etatTxt = new Label("Contenu : "+rec.getTexte(),"NewsTopLine2" );
        ...
        lSupprimer.addPointerPressedListener(l -> {
            ...
            if(dig.show("Suppression","Vous voulez supprimer ce reclamation ?","Annuler","Oui")) {
               ...
               if(ServicePublicaton.getInstance().deletePublication(rec.getIdPub())) {
